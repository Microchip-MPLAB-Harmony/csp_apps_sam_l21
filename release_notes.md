...
## Harmony 3 peripheral library application examples for SAM L21 family v3.6.1
...
|:-----------------:|:-------------------:|
| [SAM L21 Xplained Pro Evaluation Kit](https://www.microchip.com/developmenttools/ProductDetails/ATSAML21-XPRO-B) | 38 |
...
## Harmony 3 peripheral library application examples for SAM L21 family v3.6.0
...
## Harmony 3 peripheral library application examples for SAM L21 family v3.5.0
...
## Harmony 3 peripheral library application examples for SAM L21 family  v3.4.0
...
## Harmony 3 peripheral library application examples for SAM L21 family  v3.3.0
...
## Harmony 3 peripheral library application examples for SAM L21 family  v3.2.0
...
| Development Kits  | MPLAB X applications |
|:-----------------:|:-------------------:|
| [SAM L21 Xplained Pro Evaluation Kit](https://www.microchip.com/developmenttools/ProductDetails/ATSAML21-XPRO-B) | 37 |
...
## Harmony 3 peripheral library application examples for SAM L21 family  v3.1.0
...
## Harmony 3 peripheral library application examples for SAM L21 family  v3.0.1
...
## Harmony 3 peripheral library application examples for SAM L21 family  v3.0.0
...
- Applications migrated from csp repository to this new application repository for SAM L21 development boards
